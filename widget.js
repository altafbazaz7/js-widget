...
class MessageWidget {
  ...
  async initialize() {
    ...
    widgetIconElement.innerHTML = '<img src="https://wmuza.github.io/SocketIO-Chat-App/public/img/sa.png" />';
    ...
    closeIconElement.innerHTML = '<img src="path/to/close-icon.png" />';
    ...
    /**
     * Invoke the `createWidgetContent()` method
     */
     ...
     */
    this.widgetContainer.appendChild(buttonContainer);
...
// Usage
const widget = new MessageWidget();
widget.initialize();
